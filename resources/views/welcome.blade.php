...
<head>
  ...
  <link rel="icon" type="image/png" href="/images/mlc.jpg">
...
<body class="off-canvas-sidebar">
  ...
  <div class="wrapper wrapper-full-page">
    <div class="page-header login-page header-filter" filter-color="black" style="background-image: url('/images/saer3.jpg'); background-size: cover; background-position: top center;">
            ...
            <form method="POST" action="/check">
              ...
              <div class="card card-login card-hidden">
                <div class="card-header card-header-rose text-center">
                  <h4 class="card-title">Recouvrement</h4>
                ...
                <div class="card-body ">
                  ...
                  <span class="bmd-form-group">
                    <div class="input-group">
                      ...
                      <input type="text" placeholder="Login..." class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
                      @error('name')
                  ...
                  <span class="bmd-form-group">
                    <div class="input-group">
                      ...
                      <input type="password" placeholder="Password..." class="form-control @error('name') is-invalid @enderror" name="password" value="{{ old('name') }}" required autocomplete="name" autofocus>
                      @error('password')
                      <span class="invalid-feedback" role="alert">
                          <strong>{{ $message }}</strong>
                      </span>
        ...
        <div class="container">
          ...
          <div class="copyright float-right">
           MaliCreances &copy;
            ...
            </script>, developed by FANE Ousmane.
          </div>
        </div>
      </footer>
    </div>
