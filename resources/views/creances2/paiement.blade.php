...
@section('navbar')
<a class="navbar-brand" href="#">Paiement => Effectuer un paiement</a>
@endsection
@section('nav')
<ul class="nav">
    <li class="nav-item ">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="card ">
                ...
                <h4 class="card-title">Date Paiement</h4>
                </div>
                <div class="card-body ">
                <div class="form-group">
                    <input type="date" class="form-control datepicker" name="date_paiement">
                </div>
                </div>
            </div>
            </div>
            ...
            <div class="card ">
                ...
                <h4 class="card-title">ID Creance</h4>
                </div>
                <div class="card-body ">
                <div class="form-group">
