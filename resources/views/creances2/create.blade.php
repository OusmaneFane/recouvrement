...
<div class="content">
    ...
    <form method="POST" action="/add_creance2">
        @csrf
            ...
            <div class="row">
                ...
                <div class="card ">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control datetimepicker" name="montant" >
                    </div>
                    </div>
                </div>
                </div>
                ...
                <div class="card ">
                    ...
                    <h4 class="card-title">Date Dette</h4>
                    </div>
                    <div class="card-body ">
                    <div class="form-group">
                        <input type="date" class="form-control datepicker" name="date_dette">
                    </div>
                    </div>
                </div>
                </div>
                ...
                <div class="card ">
                    ...
                    <h4 class="card-title">Date Echeance</h4>
                    </div>
                    <div class="card-body ">
                    <div class="form-group">
                        <input type="date" class="form-control timepicker" name="date_echeance">
                    </div>
                    </div>
                </div>
                </div>
                <div class="col-md-4">
                    ...
                    <div class="card-header card-header-rose card-header-text">
                        ...
                        <h4 class="card-title">Ident emprunteur</h4>
                    </div>
                    <div class="card-body ">
                        <div class="form-group">
                        <input type="text" class="form-control timepicker" name="id_emprunteur">
                        </div>
                    </div>
                    </div>
                </div>
