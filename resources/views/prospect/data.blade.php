                    ...
                    <div class="row">
                      ...
                      <div class="col-md-9">
                        <div class="form-group has-default">
                          <input type="text" name="prospect_type" class="form-control" value="{{$data->prospect_type}}">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-9">
                          <div class="form-group has-default">
                            <input type="text" name="nature" class="form-control" value="{{$data->nature}}">
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        ...
                        <div class="col-md-9">
                          <div class="form-group has-default">
                            <input type="text" name="apporteur" class="form-control" value="{{$data->apporteur}}">
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        ...
                        <div class="col-md-9">
                          <div class="form-group has-default">
                            <input type="text" name="statut" class="form-control" value="{{$data->statut}}">
                          </div>
                        </div>
                      </div>
            ...
            <div class="card-body ">
              <div class="form-horizontal">
                <div class="row">
                  ...
                  <div class="col-md-9">
                    <div class="form-group has-default">
                      <input type="text" name="pays" class="form-control" value="{{$data->pays}}">
                    </div>
                  </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-9">
                      <div class="form-group has-default">
                        <input type="text" name="type_apporteur" class="form-control" value="{{$data->type_apporteur}}">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    ...
                    <div class="col-md-9">
                      <div class="form-group has-default">
                        <input type="text" name="charge_client" class="form-control" value="{{$data->charge_client}}">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    ...
                    <div class="col-md-9">
                      <div class="form-group has-default">
                        <input type="text" name="capital" class="form-control" value="{{$data->capital}}">
                      </div>
                    </div>
                  </div>
